...
public:
    ...
    void process() {
        ...
        // Assuming Estimated Views will always be empty at this point 
        ...
        DataStructures::printColsRows(visible, "Visible");
        ...
        for(int i=0; i<1; i++){
            ...
            if (status==0){
                std::array<int, 2> initial_views = {first_view, second_view};
